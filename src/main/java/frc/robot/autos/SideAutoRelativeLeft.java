...
public class SideAutoRelativeLeft extends SequentialCommandGroup {
    public SideAutoRelativeLeft(
        ...
        addCommands(
            drivetrain.applyRequest(() -> drive.withRotationalRate(-0.5 * MaxAngRate))
